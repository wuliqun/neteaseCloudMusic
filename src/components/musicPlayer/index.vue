<template>
	<div id="player" :class="{ 'locked': locked, 'mouse-active': mouseActive, 'list-active': listAct }"
			...
			<div class="setting">
				...
				<div class="play-list">
					...
					<div class="list-detail">
						...
						<div class="list-wrap">
							<ul class="list">
								<li v-for="(item, index) in playlist" class="clearfix" :class="{ current: index == currentIndex }"
									@click="playIndex(index)" :key="item.id">
									<div class="col col-1">
...
#player .list-detail .head .add-all,
#player .list-detail .head .clear {
	float: left;
	margin-right: 20px;
	color: #ccc;
}
